	...
	<body>
		...
		<div id="show-course" class="content scaffold-show" role="main">
			...
			<ol class="property-list course">
				...
				<g:if test="${courseInstance?.groups}">
				<li class="fieldcontain">
					<span id="groups-label" class="property-label"><g:message code="course.groups.label" default="Groups" /></span>
					
						<g:each in="${courseInstance.groups}" var="g">
						<span class="property-value" aria-labelledby="groups-label"><g:link controller="mentorGroup" action="show" id="${g.id}">${g?.encodeAsHTML()}</g:link></span>
						</g:each>
				...
				<li class="fieldcontain">
					<span id="tutor-label" class="property-label"><g:message code="course.tutor.label" default="Tutor" /></span>
						...
						<span class="property-value" aria-labelledby="tutor-label"><g:link controller="tutor" action="show" id="${courseInstance?.tutor?.id}">${courseInstance?.tutor?.encodeAsHTML()}</g:link></span>
